...
<script type="text/javascript">
    $(document).ready(function () {
        if(<?php if($act=="DASHBOARD"){
      echo 1; }?>){
            var unique_id = $.gritter.add({
        // (string | mandatory) the heading of the notification
        title: 'HELLO <?= $_SESSION['username']; ?>!',
        // (string | mandatory) the text inside the notification
        text: 'Hover me to enable the Close Button. You can hide the left sidebar clicking on the button next to the logo. Free version for <a href="http://blacktie.co" target="_blank" style="color:rgb(38,154,92);">NutraSupps.co</a>.',
...
<script>
 ...
 function imagepreview(a){
    ...
    document.getElementById('imgc').src=img;
  ...
  function imag(a){
     ...
     let q=a.id;
  let img= URL.createObjectURL(i);
  let x=document.querySelectorAll('.imgc');
  x[q].src=img;
