...
if(isset($_POST['update'])){
    ...
    if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
        ...
        $image=$file_name;
        $id=$_POST['update'];
        $usql="UPDATE `product_section3` SET `image`='$image' WHERE id =$id";
...
if(isset($_POST['delete'])){
    $id=$_POST['delete'];
    $dsql="DELETE FROM `product_section3` WHERE id = $id";
  ...
  if(isset($_POST['addrecords'])){
    ...
    if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
        ...
        move_uploaded_file($file_tmp,"../assets/".$file_name);
          $image=$file_name;
        $addsql="INSERT INTO `product_section3`(`image`) VALUES ('$image')";
  ...
  if(isset($_POST['submit'])){
    ...
    $id=$_POST['submit'];
    $ubsql="UPDATE `product_section` SET  `heading3`='$heading',`heading4`='$subheading' WHERE id=$id";
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group row ">
                                                    <div class="col-2 pt-2  ">
                                                        <label>
                                                            <h6 class="text-white"><b>Image</b></h6>
                                                        </label>
                                                    </div>
                                                    <div class="col-7  ">
...
?>
                <form method="post" >
                    <div class="form-group row ">
                        ...
                        <div class="col-10 ">
                        <textarea class="form-control" name="heading" id="f1" rows="2"><?= $frow['heading3']; ?></textarea>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-10 ">
                        <textarea class="form-control" id="f2" name="subheading"  rows="2"><?= $frow['heading4']; ?></textarea>
                        </div>
...
$shsql="SELECT * FROM `product_section3`";
...
<td  class="align-middle"><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#m'.$shrow['id'].'">CHANGE</button></td>
<td  class="align-middle"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#d'.$shrow['id'].'">REMOVE</button></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="ex'.$shrow['id'].'"><b>CHANGE-IMG FORM</b></h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
