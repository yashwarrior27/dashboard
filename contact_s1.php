...
if(isset($_POST['submitq'])){
    ...
    $id=$_POST['submitq'];
        $image=$file_name;
        $usql="UPDATE `contact_head` SET `heading1`='$head1',`heading2`='$head2',`image`='$image' WHERE id = $id";
    ...
    $id=$_POST['submitq'];
        $bgimage=$file_name;
        $usql="UPDATE `contact_head` SET `heading1`='$head1',`heading2`='$head2',`background`='$bgimage' WHERE id = $id";
        $uresult=mysqli_query($conn,$usql);
        if($uresult){
            $msg="update successful";
        }
    ...
    $id=$_POST['submitq'];
        $bgimage=$file_bgname;
        $image=$file_name;
        $usql="UPDATE `contact_head` SET `heading1`='$head1',`heading2`='$head2',`image`='$image',`background`='$bgimage' WHERE id = $id";
        $uresult=mysqli_query($conn,$usql);
        if($uresult){
            $msg="update successful";
        }
    ...
    $head2=$_POST['heading2'];
    $id=$_POST['submitq'];
$usql="UPDATE `contact_head` SET `heading1`='$head1',`heading2`='$head2' WHERE id = $id";
$uresult=mysqli_query($conn,$usql);
if($uresult){
            $msg="update successful";
...
<script>if (<?php if($lact==="contact"){
           echo 1;
       } else{
           echo 0;
       } ?>) {
    document.getElementById("sub-drop5").classList.add("d-block");
}</script>