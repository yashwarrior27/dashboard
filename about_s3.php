...
include("../db.php");
 ...
 if(isset($_POST['update'])){
     ...
     if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
        ...
        $desc=$_POST['desc'];
         $id=$_POST['update'];
         $usql="UPDATE `about_section2.2` SET  `image`='$image',`heading`='$head1',`description`='$desc' WHERE id =$id";
        ...
        $desc=$_POST['desc'];
         $id=$_POST['update'];
         $usql="UPDATE `about_section2.2` SET  `heading`='$head1',`description`='$desc' WHERE id =$id";
         $uresult=mysqli_query($conn,$usql);
         if($uresult){
             $msg="update successful";
         }
 ...
 if(isset($_POST['delete'])){
    $id=$_POST['delete'];
    $dsql="DELETE FROM  `about_section2.2` WHERE `id` = $id";
  ...
  if(isset($_POST['addrecords'])){
    ...
    if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
       ...
       $head1=$_POST['heading'];
       $desc=$_POST['desc']; 
        $addsql="INSERT INTO `about_section2.2` (`image`, `heading`, `description`) VALUES ('$image','$head1','$desc')";
        ...
        $head1=$_POST['heading'];
        $desc=$_POST['desc']; 
         $addsql="INSERT INTO  `about_section2.2` (`heading`, `description`) VALUES ('$head1','$desc')";
         $addresult=mysqli_query($conn,$addsql);
        if($addresult){
            $msg="add successfull";
        }
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-10 ">
                                                          <textarea class="form-control" id="f2" rows="2" name="desc"></textarea>
...
$shsql="SELECT * FROM `about_section2.2`";
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <form method="post"  enctype="multipart/form-data">
                    ...
                    <div class="col-10 ">
                    <textarea class="form-control" id="f2" rows="2" name="desc">'.$shrow['description'].'</textarea>
                    </div>
