...
include("../db.php");
 ...
 if(isset($_POST['update'])){
     ...
     if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
        ...
        $link=$_POST['plink'];
         $id=$_POST['update'];
         $usql="UPDATE `product_section1.2` SET `image`='$image',`heading`='$head1',`plink`='$link' WHERE id =$id";
        ...
        $link=$_POST['plink'];
         $id=$_POST['update'];
         $usql="UPDATE `product_section1.2` SET `heading`='$head1',`plink`='$link' WHERE id =$id";
         $uresult=mysqli_query($conn,$usql);
         if($uresult){
             $msg="update successful";
         }
 ...
 if(isset($_POST['delete'])){
    $id=$_POST['delete'];
    $dsql="DELETE FROM  `product_section1.2` WHERE `id` = $id";
  ...
  if(isset($_POST['addrecords'])){
    ...
    if(isset($_FILES['image'])&&$_FILES['image']['error']==0){
       ...
       $head1=$_POST['heading'];
       $link=$_POST['plink']; 
        $addsql="INSERT INTO  `product_section1.2` (`image`, `heading`, `plink`) VALUES ('$image','$head1','$link')";
        ...
        $head1=$_POST['heading'];
        $link=$_POST['plink']; 
         $addsql="INSERT INTO  `product_section1.2` (`heading`, `plink`) VALUES ('$head1','$link')";
         $addresult=mysqli_query($conn,$addsql);
        if($addresult){
            $msg="add successfull";
        }
  ...
  if(isset($_POST['submit'])){
   ...
   $id=$_POST['submit'];
   $headsql="UPDATE  `product_section` SET `heading1`='$head',`heading2`='$headsub' WHERE id=$id ";
                    ...
                    <div class="modal fade" id="chghead" tabindex="-1" aria-labelledby="chgheadLabel"
                        ...
                        <div class="modal-dialog  modal-xl">
                            <div class="modal-content">
                                ...
                                <?php
      $fsql="SELECT * FROM `product_section`";
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-10 ">
                                                        <input class="form-control" value=" " name="heading" id="f1"
                                                            type="text">
                                                    </div>
                                                ...
                                                <div class="form-group row ">
                                                    <div class="col-2 pt-2 text-dark ">
                                                        <label for="f1">
                                                            <h6><b>Product-Link</b></h6>
                                                        </label>
                                                    </div>
                                                    <div class="col-10 ">
                                                        <input class="form-control" value=" " name="plink" id="f1"
                                                            type="text">
                                                    </div>
...
$shsql="SELECT * FROM `product_section1.2`";
...
<td class="align-middle">'.$shrow['plink'].'</td>
        ...
        <div class="row">
          ...
          <form method="post"  enctype="multipart/form-data">
                       <div class="form-group row ">
                        ...
                        <div class="col-10 ">
                            <input class="form-control" value="'.$shrow['heading'].'" name="heading" id="f2"
                                type="text">
                        </div>
                    ...
                    <div class="col-10 ">
                        <input class="form-control" value="'.$shrow['plink'].'" name="plink" id="f2"
                            type="text">
                    </div>
